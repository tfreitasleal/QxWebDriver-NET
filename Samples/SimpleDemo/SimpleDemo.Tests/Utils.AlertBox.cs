...
namespace SimpleDemo.Tests
{
    public static partial class Utils
    {
        ...
        public static IWidget AlertBoxGet(this QxWebDriver driver, MessageBoxIcon alertBoxIcon,
        ...
        public static IWidget AlertBoxGet(this QxWebDriver driver, string alertBoxMessage = "",
            long timeoutInSeconds = 5)
        {
            return AlertBoxGetCore(driver, MessageBoxIcon.None, true, alertBoxMessage, timeoutInSeconds);
        }

        private static IWidget AlertBoxGetCore(this QxWebDriver driver, MessageBoxIcon alertBoxIcon, bool ignoreIcon,
            string alertBoxMessage = "", long timeoutInSeconds = 5)
        {
            var alertBoxManagerBy = QxhByString("qx.ui.container.Composite");
        ...
        private static IWidget WaitForAlertBox(this QxWebDriver driver, IWidget alertBoxManager,
        ...
        public static void AlertBoxClose(this QxWebDriver driver, MessageBoxIcon alertBoxIcon,
            string alertBoxMessage = "", long timeoutInSeconds = 5)
        {
            AlertBoxCloseCore(driver, alertBoxIcon, false, alertBoxMessage, timeoutInSeconds);
        }

        public static void AlertBoxClose(this QxWebDriver driver, string alertBoxMessage = "",
            long timeoutInSeconds = 5)
        {
            AlertBoxCloseCore(driver, MessageBoxIcon.None, true, alertBoxMessage, timeoutInSeconds);
        }

        private static void AlertBoxCloseCore(this QxWebDriver driver, MessageBoxIcon alertBoxIcon, bool ignoreIcon,
            string alertBoxMessage = "", long timeoutInSeconds = 5)
        {
